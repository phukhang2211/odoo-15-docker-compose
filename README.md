...
``` bash
curl -s https://raw.githubusercontent.com/phukhang2211/odoo-15-docker-compose/master/run.sh | sudo bash -s odoo-one 10015 20015
```

to set up first Odoo instance @ `localhost:10015` (default master password: `Admin@123`)

and

``` bash
curl -s https://raw.githubusercontent.com/phukhang2211/odoo-15-docker-compose/master/run.sh | sudo bash -s odoo-two 11015 21015
```

to set up another Odoo instance @ `localhost:11015` (default master password: `Admin@123`)
...
``` sh
$ git clone https://github.com/phukhang2211/odoo-15-docker-compose
